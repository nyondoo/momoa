module.exports = {
  fetchgoal: `${process.env.REACT_APP_SERVER_IP}/api/getgoal`,
  fetchGraph: `${process.env.REACT_APP_SERVER_IP}/api/getsheetdata`,
  ...
  createAccount: `${process.env.REACT_APP_SERVER_IP}/api/check_email`,
  fetchCalendar: `${process.env.REACT_APP_SERVER_IP}/api/getcalendar`,
  finalSignup: `${process.env.REACT_APP_SERVER_IP}/api/signup2`,
  eventHandle: `${process.env.REACT_APP_SERVER_IP}/api/users`,
  getSheetData: `${process.env.REACT_APP_SERVER_IP}/api/getsheetdata`,
  interceptor1: `${process.env.REACT_APP_SERVER_IP}/api/verify`,
  interceptor2: `${process.env.REACT_APP_SERVER_IP}/api/token`,
  getAccesstoken: `${process.env.REACT_APP_SERVER_IP}/api/getkakao`,
};
